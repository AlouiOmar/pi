 ...
 * @author Raef
 */
public class AfficherAccessoireUserController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
          try {
            Services.ServiceAccessoire sv = new ServiceAccessoire();
        

           ArrayList<Accessoire> lr;
       
            lr = (ArrayList<Accessoire>) sv.getAccessoires();
  ...
  public void displayAll(List<Accessoire> lp) {
         VBox vbox = new VBox();
//        int i = 0;
//        int j = 0;
//        HBox hbox = new HBox();
        for (Accessoire p : lp) {
//            if (i == 0) {
//                hbox.setSpacing(10);//                hbox = new HBox();
...
//            }
            ...
            try {
                ...
                Logger.getLogger(AfficherAccessoireController.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//            }
   ...
   public void createQR(Accessoire p, AnchorPane root) {
