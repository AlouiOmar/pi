...
public class ModifierAnnonceController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        hamburger.setStyle(" -jfx-focus-color: #ffff ");
...
//            cat.getItems().add("accessoire");
        ...
        imageUrl = "C:\\codenameone\\velo11\\src\\edu\\velo\\uploads\\"+a.getPhoto();
        ...
        ty.setValue(a.getType());
        ty1.setValue(a.getTypevelo());
        prix.setText(String.valueOf(a.getPrix()));
        cat.setValue(a.getCategorie());
        gv.setValue(a.getGouvernorat());
        couleur.setText(String.valueOf(a.getCouleur()));
        description.setText(a.getDescription());        
        date.setValue(a.getDate().toLocalDate());
        // TODO
    }    
    ...
    private void ModifierAnnonce(ActionEvent event) throws IOException {
        ...
        System.out.println("clicked button modifier");
        a=as.getAnnonce(Vars.current_annonce.getIda());
