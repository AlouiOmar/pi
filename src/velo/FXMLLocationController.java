...
//      Location l = new Location(1, titre.getText(), Date.valueOf(dateDeb.getValue()), Date.valueOf(dateFin.getValue()),
//                Integer.valueOf(duree.getText()), lieu.getText(),Float.valueOf(prix.getText()),lieu.getText());
//        try {
//            SL.getById(id);
